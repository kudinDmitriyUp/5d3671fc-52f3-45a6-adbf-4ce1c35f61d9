...
export const metadata: Metadata = {
  title: "AIFlow - Intelligent Automation for Modern Teams",
  description: "Harness AI to automate workflows, reduce manual work, and accelerate growth. Join 50K+ teams using AIFlow for intelligent automation.",
  keywords: "AI automation, machine learning, workflow automation, AI tools, business automation, intelligent processing",
  metadataBase: new URL("https://aiflow.com"),
  alternates: {
    canonical: "https://aiflow.com"
  },
  openGraph: {
    title: "AIFlow - Intelligent Automation Platform",
    description: "Transform your workflows with powerful AI automation built for enterprise teams.",
    siteName: "AIFlow",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "AIFlow - AI Automation Platform",
    description: "Automate complex workflows and unlock team productivity with AI"
  },
  robots: {
    index: true,
    follow: true
